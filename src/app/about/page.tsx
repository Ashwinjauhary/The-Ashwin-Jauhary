...
export default function About() {
  return (
    <div className="max-w-[1400px] mx-auto px-4 py-8 min-h-screen font-sans text-foreground">
      ...
      <div className="text-center border-b-[6px] border-double border-foreground pb-4 mb-10">
        ...
        <h1 className="font-['Playfair_Display'] text-5xl md:text-7xl font-black uppercase tracking-tight text-foreground">The Reporter</h1>
        <p className="font-['Lora'] italic text-base mt-2 text-foreground/60">An exclusive biography at the intersection of code, craft, and ambition.</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        <article className="lg:col-span-7 border-r-0 lg:border-r-[1.5px] border-foreground/40 pr-0 lg:pr-10">
          ...
          <h2 className="font-['Playfair_Display'] text-4xl md:text-5xl font-black uppercase mb-4 leading-tight text-foreground">
        ...
        <aside className="lg:col-span-5 space-y-8">
          ...
          {/* Contact Block */}
          <div className="border-[3px] border-foreground p-5 bg-foreground text-background">
            ...
            <div className="space-y-3 font-['Lora'] text-sm">
              <a href={`mailto:${profile.email}`} className="flex gap-3 items-center hover:opacity-70 transition-opacity">
              ...
              <a href={profile.github} target="_blank" className="flex gap-3 items-center hover:opacity-70 transition-opacity">
                ...
                github.com/Ashwinjauhary
              </a>
              <a href={profile.linkedin} target="_blank" className="flex gap-3 items-center hover:opacity-70 transition-opacity">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>
                linkedin.com/in/ashwin-jauhary
              </a>
            </div>
          </div>
